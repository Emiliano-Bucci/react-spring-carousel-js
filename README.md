...
| initialStartingPosition | `left` / `center` / `right`                                                     | `left`        | `Note: only works if withLoop={true}` Defines the starting position of the current active aslide. Normally if you have 3 active items per `slide`, you'll see 1,2,3. If you set `initialStartingPosition='center'`, for example, you'll get the following order: 3,1,2.                                                              |
